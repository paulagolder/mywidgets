...
public class jswTextField extends jswPanel
{
	...
	{
		textbox.setBorder(jswStyle.makeLineBorder(Color.blue,3));
		textbox.setBackground(Color.LIGHT_GRAY);
		Dimension dt = new Dimension(bl-4, bh-4);
		textbox.setPreferredSize(dt);
		textbox.setMaximumSize(dt);
		textbox.setMinimumSize(dt);
		...
		setMaximumSize(d);
		setMinimumSize(d);
		//setBorder(jswStyle.makeLineBorder(Color.blue,3));
